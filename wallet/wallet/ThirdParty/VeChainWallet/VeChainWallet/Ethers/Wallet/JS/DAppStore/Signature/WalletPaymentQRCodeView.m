...
- (void)initView
{
    ...
    [WalletTools circualarView:_contentView Radius:4];
    ...
    [WalletTools circualarView:_confirmBtn Radius:4];
    ...
    case HotWalletQrCodeType:
        {
            ...
            UIImage *qrCodeImage = [WalletTools creatQRcodeImage:_jsonStr];
