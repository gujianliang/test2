...
// 普通节点模型
@implementation WalletNomelNodeModel
- (instancetype)init{
    self = [super init];
    if (self) {
...
// X节点模型
@implementation WalletXNodeModel
- (instancetype)init{
    self = [super init];
    if (self) {
...
@implementation WalletConvertNodeModel


- (WalletNomelNodeModel *)nomelNodelModel{
    if (!_nomelNodelModel) {
        _nomelNodelModel = [[WalletNomelNodeModel alloc] init];
    }
    
    return _nomelNodelModel;
}

- (WalletXNodeModel *)xnodelModel{
    if (!_xnodelModel) {
        _xnodelModel = [[WalletXNodeModel alloc] init];
    }
