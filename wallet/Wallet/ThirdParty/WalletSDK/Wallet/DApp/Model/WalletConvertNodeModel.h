...
// 普通节点模型
@interface WalletNomelNodeModel : NSObject
...
// X节点模型
@interface WalletXNodeModel : NSObject
...
@interface WalletConvertNodeModel : NSObject
...
@property (strong, nonatomic) WalletNomelNodeModel *nomelNodelModel;  // 普通节点模型
@property (strong, nonatomic) WalletXNodeModel *xnodelModel;          // x节点模型
