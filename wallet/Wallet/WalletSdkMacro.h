...
#define     Test_Node      @"https://vethor-node-test.digonchain.com"      /* The test Node environment of block */
#define     Main_Node      @"https://vethor-node.digonchain.com"           /* The main Node environment of block */
